...
void CTriggerFall::FallTouch( CBaseEntity *pOther )
{
	...
	default:
	case 0:
		EMIT_SOUND( ENT( pOther->pev ), CHAN_STATIC, "scream1.wav", 1, ATTN_NORM );
		break;
	case 1:
		EMIT_SOUND( ENT( pOther->pev ), CHAN_STATIC, "scream2.wav", 1, ATTN_NORM );
		break;
	case 2:
		EMIT_SOUND( ENT( pOther->pev ), CHAN_STATIC, "scream3.wav", 1, ATTN_NORM );
		break;
	}
